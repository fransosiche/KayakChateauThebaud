                            ...
                            <tr>
                                ...
                                <td colspan="3" rowspan="3" bgcolor="#FFFFFF" style="padding:0 0 30px;">
                                    ...
                                    <p style="margin:0 30px 33px;; text-align:center; text-transform:uppercase; font-size:24px; line-height:30px; font-weight:bold; color:#484a42;">
                                        Nouvelle réservation de {{$data['Surname']}} {{$data['Name']}}
                                    </p>
                                    <!-- begin articles -->
                                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                        <tbody>
                                        <tr valign="top">
                                            ...
                                            <td colspan="3">
                                                ...
                                                <p style="margin:0 30px 33px; text-align:center; text-transform:uppercase; font-size:14px; line-height:30px; font-weight:bold; color:#484a42;">
                                                    Jour de location :  {{$myDateTime = DateTime::createFromFormat('Y-m-d', $data['Location_Date'])->format('d-m-Y')}}
                                                </p>
                                                <p style="margin:0 30px 33px; text-align:center; text-transform:uppercase; font-size:14px; line-height:30px; font-weight:bold; color:#484a42;">
                                                    Créneau : {{$data['Start_Time']}} {{$data['End_Time']}}
                                                </p>
                                                <p style="margin:0 30px 33px; text-align:center; text-transform:uppercase; font-size:14px; line-height:30px; font-weight:bold; color:#484a42;">
                                                    ALCKCT
                                                </p>
