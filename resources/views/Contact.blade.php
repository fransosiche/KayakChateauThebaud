                    ...
                    <form action="/Contact" method="POST">
                        ...
                        <div class="row form-group">
                            <div class="col-md-6">
                                ...
                                <input name="fsurname" type="text" id="fsurname" class="form-control @error('fsurname') is-invalid @enderror"
                                       placeholder="{{ __('Prénom') }}" value="{{ old('fsurname') }}" required autocomplete="fsurname">
                                @error('fsurname')
                            ...
                            <div class="col-md-6">
                                ...
                                <input name="fname" type="text" id="fname" class="form-control @error('fname') is-invalid @enderror" placeholder="{{ __('Nom') }}"
                        ...
                        <div class="row form-group">
                            <div class="col-md-12">
                                ...
                                <input name="Sujet" type="text" id="subject" class="form-control"
                        ...
                        <div class="row form-group">
                            <div class="col-md-12">
                                ...
                                <textarea name="Message" id="message" cols="30" rows="10" class="form-control"
                                          placeholder="Le message que vous souhaitez nous faire parvenir"></textarea>
                            </div>
                        </div>
